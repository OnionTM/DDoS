...
| $$  \ $$| $$ /$$__  $$| $$      | $$_  $$ | $$$/ \  $$$| $$| $$  | $$
| $$$$$$$/| $$|  $$$$$$$|  $$$$$$$| $$ \  $$| $$/   \  $$| $$| $$  | $$
|_______/ |__/ \_______/ \_______/|__/  \__/|__/     \__/|__/|__/  |__/
...
def usage():
    ...
    print                              THEDON_BANNER
    print
    print  color.CYAN + ' Telegram : @BlackWin ' + color.END
    print
    print  color.OKBLUE + ' USAGE: python2 m4s9b8.py <url> [OPTIONS]' + color.END
    print
    print ' OPTIONS:'
    ...
    print
    print
    print color.OKBLUE + ' BlackWin & Redxor ' + color.END
    print
    print
    print color.NOTICE + '################################################################################' + color.END
    print
